...
- **响应验证**: 验证状态码、响应头、响应体
- **参数验证**: 测试查询参数、路径参数、请求体
- **错误处理测试**: 测试各种错误情况（400, 404, 500）

### Mock 策略

- 使用 `unittest.mock.patch` mock 服务层方法
- 使用 fixture 提供 Flask app 和 client
- 使用 fixture 准备测试数据（模拟 MIB 数据、设备数据等）
